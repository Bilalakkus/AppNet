...
namespace AppNet.Infrastructer.Persistence.Migrations
{
    ...
    [Migration("20220613184652_dbIsItPassive")]
    partial class dbIsItPassive
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AppNet.Domain.Entities.Concrete.Stock", b =>
                {
                    b.HasOne("AppNet.Domain.Entities.Concrete.Customer", null)
                        .WithMany("Stocks")
                        .HasForeignKey("CustomerId");

                    b.HasOne("AppNet.Domain.Entities.Concrete.Product", "Product")
                        .WithMany()
